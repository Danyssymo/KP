...
string adminPathFile = "C://Users//user//source//repos//SAIPIS CP Server//SAIPIS CP Server//admin.txt", userPathFile = "user.txt", admin = "Администратор", user = "Пользователь";
AdminMenu aMenu;
UserMenu uMenu;
